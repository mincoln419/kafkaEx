...
public class PizzaMultiProducer {
    public static  final Logger logger = LoggerFactory.getLogger(PizzaMultiProducer.class);
    ...
    private static Properties getProperties() {
        ...
        props.setProperty(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.145.129:9092, 192.168.145.129:9093, 192.168.145.129:9094");
