...
public class OrderSerdeConsumer<K , V> {

    public static  final Logger logger = LoggerFactory.getLogger(OrderSerdeConsumer.class);

    private KafkaConsumer<K, V> kafkaConsumer;

    private List<String> topics;

    public OrderSerdeConsumer(Properties props, List<String> topics) {
